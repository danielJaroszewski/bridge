...
namespace most
{
	namespace GUI
	{
		...
		private:
			...
			std::unique_ptr<Drawable> currentScene, newScene; // Mutable because of draw's constness.
		protected:
		...
		public:
			...
			void setScene(std::unique_ptr<Drawable>&& scene);
